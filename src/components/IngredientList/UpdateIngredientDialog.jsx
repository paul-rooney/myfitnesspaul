    ...
    >
        <Stack>
            <Stack space="var(--size-1)">
                ...
                <input
                    defaultValue={ingredient.identifier}
                    id="identifier"
                    disabled
                />
                <input
            ...
            <Stack space="var(--size-1)">
                ...
                <input
                    id="group"
                    placeholder="Tomatoes, chicken, soft drinks, etc."
                />
            </Stack>
            <Stack space="var(--size-1)">
                <label
            ...
            <Stack space="var(--size-1)">
                ...
                <input
                    defaultValue={ingredient?.brand_name}
            ...
            <Stack space="var(--size-1)">
                ...
                <input
                    className={styles.input}
                    defaultValue={ingredient.carbohydrate}
                    id="carbohydrate"
                    type="number"
                    min={0}
                    max={100}
